...
public class Ex51BH extends JFrame implements ActionListener {
	...
	public Ex51BH() {
		...
		addWindowListener(new WindowAdapter() {
			...
			int result = JOptionPane.showConfirmDialog(Ex51BH.this,"정말 종료?", "종료 확인", JOptionPane.YES_NO_OPTION);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == btnCalc) {
			...
			avg=hap/3;
			lblResult2.setText("평균: " + String.format("%.1f", avg));
			int selImage = 0;
			if(avg>=90) {
				a="A";
				selImage =1;
			...
			case 2:
				lblphto.setIcon(new ImageIcon("C:\\work\\jsou\\jpro1\\src\\pack7gui\\pack2.jpg"));
				break;
			}
